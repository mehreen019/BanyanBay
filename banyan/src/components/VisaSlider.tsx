...
const VisaSlider = () => {
    ...
    const visaItems = [
        { name: 'Malaysia', type: 'E-visa', price: '3000BDT', image: malaysia },
        { name: 'Singapore', type: 'E-visa', price: '3000BDT', image: singapore },
        { name: 'Thailand', type: 'E-visa', price: '3000BDT', image: thailand },
        { name: 'Sri Lanka', type: 'E-visa', price: '3000BDT', image: srilanka },
        { name: 'Turkey', type: 'E-visa', price: '3000BDT', image: turkey },
        { name: 'Umrah', type: 'E-visa', price: '3000BDT', image: umrah },
        { name: 'Hong Kong', type: 'E-visa', price: '3000BDT', image: hongkong },
        { name: 'China', type: 'Business visa', price: '3000BDT', image: china1 },
        { name: 'China', type: 'Tourist visa', price: '3000BDT', image: china2 },
    ];
    ...
    const selectedPrice = selectedItem !== null ? `Starting from ${visaItems[selectedItem].price}` : "";
